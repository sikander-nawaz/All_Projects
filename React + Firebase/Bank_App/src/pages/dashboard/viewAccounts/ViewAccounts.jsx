...
function ViewAccounts() {
  ...
  const [isDepositAmount, setIsDepositAmount] = useState({
    depositAmount: "0",
    description: "",
  });
  const [isWithdrawAmount, setIsWithdrawAmount] = useState({
    withdrawAmount: "0",
    description: "",
  });
  ...
  const handleDeposit = async () => {
    let newDocument = documents.find((object) => {
      // will store selected object using find method
      return docId == object.id;
    });
    ...
    newDocument.initialDeposit = (
      parseInt(initialDeposit) + parseInt(depositAmount)
    ).toString();
  ...
  const handleWithdraw = async () => {
    ...
    newDocument.initialDeposit = (
      parseInt(initialDeposit) - parseInt(withdrawAmount)
    ).toString();
                  ...
                  <>
                    {documents.length < 1 ? (
                      <div className="text-center my-5">
                        <p>We don't have any Account yet!</p>
                        <Link
